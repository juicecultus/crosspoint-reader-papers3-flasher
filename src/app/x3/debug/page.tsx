...
export default function X3Debug() {
      ...
      <Stack gap={3} as="section">
        <div>
          ...
          <Stack gap={1} color="grey" textStyle="sm">
            <p>
              These are few tools to help debugging / administering your Xteink
              X3 device. They're designed to be used by those who are
            ...
            <p>
              ...
              installed on each (CrossPoint or Custom/Unknown).
            </p>
          </Stack>
        </div>
        <Stack as="section">
